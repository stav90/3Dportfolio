...
import FloorAndWalls from './RoomComponents/FloorAndWalls'
import BoomBox from './RoomComponents/BoomBox'
import Desk from './RoomComponents/Desk'
import OfficeDesk from './RoomComponents/OfficeChair'
import NikeShoes from './RoomComponents/NikeShoes'
import OfficeComputer from './RoomComponents/OfficeComputer'
...
{    
    ...
    const resetCameraAngle = () => {
        ...
        timeline.to('.back-button', {opacity:0})
    ...
    const aboutMeAngle = () => {
        controls.enabled = true
        const timeline = gsap.timeline()
        timeline.to('.back-button', {opacity:1})
        ...
        timeline.to('.htmlScreen', {autoAlpha: 1})
    }

    const projectsAngle = () => {
        controls.enabled = true
        const timeline = gsap.timeline()
        timeline.to('.back-button', {opacity:1}, 0)
        timeline.to('.htmlScreen', {visibility: 'hidden'}, 0) 
